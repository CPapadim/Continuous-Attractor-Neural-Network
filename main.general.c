...
void swmnet_init()
{
	...
	gNMDA_W_Array = malloc(Ne * Nt * sizeof(float));
	...
	scalarMultiply_matrix(W_Array,Nt,0,Ne,Nt,0,Ne,gNMDA_pyr,gNMDA_W_Array,Ne,0,Nt,0);
	scalarMultiply_matrix(W_Array,Nt,0,Ne,Nt,Ne,Nt,gNMDA_int,gNMDA_W_Array,Ne,0,Nt,Ne);
...
//	print_matrix(gGABA_W_Array,Ni,Nt);
	...
	init_float_matrix(s_nmda,Ne,1,0);
